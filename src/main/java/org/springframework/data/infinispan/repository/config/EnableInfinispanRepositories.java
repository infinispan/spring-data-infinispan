...
import org.springframework.data.infinispan.repository.support.InfinispanRepositoryFactoryBean;
...
public @interface EnableInfinispanRepositories {
    ...
    *
    * @EnableInfinispanRepositories("org.my.pkg")} instead of {@code @EnableInfinispanRepositories(basePackages="org.my.pkg")}.
    */
    ...
    * InfinispanRepositoryFactoryBean}.
    *
    * @return
    */
   Class<?> repositoryFactoryBeanClass() default InfinispanRepositoryFactoryBean.class;
